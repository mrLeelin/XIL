...
namespace wxb
{
    ...
    public static class hotMgr
    {
        ...
        static public void InitHotModule()
        {
            ...
            try
            {
                DllStream = CopyStream(ResLoad.GetStream(PathHelper.GetHotDllPath));
                {
#if USE_PDB
                    SymbolStream = CopyStream(ResLoad.GetStream(Path.ChangeExtension(PathHelper.GetHotDllPath,".pdb")));
